...
# This version of the script does not use an encrypted protocol
# just use it inside a trussed network
...
USERS=("backupUserServer1,backupUserServer2")
PW_FILES=("paswordFileServer1,paswordFileServer2")

#ACHTUNG: ACLs werden auf NAS nicht unterstützt ( -A)
RSYNC_OP="-aXzh --numeric-ids --delete --ignore-errors --fake-super --stats"
